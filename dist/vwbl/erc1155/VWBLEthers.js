...
var VWBLERC1155Ethers = /** @class */ (function (_super) {
    ...
    function VWBLERC1155Ethers(props) {
         ...
         */
        _this.mintToken = function (amount, royaltiesPercentage) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.safeTransfer = function (to, tokenId, amount, data) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.nft.safeTransfer(to, tokenId, amount, data)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
         ...
         */
        _this.burn = function (owner, tokenId, amount) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.burn(owner, tokenId, amount)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
         ...
         * @param tokenId - The ID of NFT
         */
        _this.balanceOf = function (owner, tokenId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.balanceOf(owner, tokenId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        _this.getOwner = function (tokenId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.getOwner(tokenId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        ...
        _this.opts = props;
        var contractAddress = props.contractAddress, ethersProvider = props.ethersProvider, ethersSigner = props.ethersSigner, uploadMetadataType = props.uploadMetadataType;
        _this.nft = new VWBLERC1155EthersContract(contractAddress, uploadMetadataType === UploadMetadataType.IPFS, ethersProvider, ethersSigner);
        return _this;
    }
    return VWBLERC1155Ethers;
}(VWBLBase));
export { VWBLERC1155Ethers };

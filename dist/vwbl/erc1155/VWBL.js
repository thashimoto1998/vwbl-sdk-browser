...
var VWBLERC1155 = /** @class */ (function (_super) {
    ...
    function VWBLERC1155(props) {
        ...
        _this.opts = props;
        var web3 = props.web3, contractAddress = props.contractAddress, uploadMetadataType = props.uploadMetadataType;
        _this.nft = new VWBLERC1155Contract(web3, contractAddress, uploadMetadataType === UploadMetadataType.IPFS);
        return _this;
    }
    return VWBLERC1155;
}(VWBLBase));

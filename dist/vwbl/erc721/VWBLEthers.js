...
var VWBLEthers = /** @class */ (function (_super) {
    __extends(VWBLEthers, _super);
    function VWBLEthers(props) {
         ...
         */
        _this.mintToken = function (royaltiesPercentage) { return __awaiter(_this, void 0, void 0, function () {
         ...
         * @param tokenId - The ID of NFT
         */
        _this.approve = function (operator, tokenId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.approve(operator, tokenId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
         ...
         * @param operator - The wallet address
         */
        _this.setApprovalForAll = function (operator) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.setApprovalForAll(operator)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
         ...
         * @param tokenId - The ID of NFT
         */
        _this.safeTransfer = function (to, tokenId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nft.safeTransfer(to, tokenId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        _this.nft = new VWBLNFTEthers(contractAddress, uploadMetadataType === UploadMetadataType.IPFS, ethersProvider, ethersSigner);
        return _this;
    }
    return VWBLEthers;
}(VWBLBase));

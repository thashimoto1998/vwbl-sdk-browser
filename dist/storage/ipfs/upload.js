    ...
    UploadToIPFS.prototype.uploadEncryptedFile = function (encryptedContent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        encryptedContentData = new Blob([encryptedContent]);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 4: return [2 /*return*/, "https://nftstorage.link/ipfs/".concat(cid)];
                }
            });
        });
    };
    UploadToIPFS.prototype.uploadThumbnail = function (thumbnailImage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        thumbnailFileType = getMimeType(thumbnailImage);
                        thumbnailblob = new Blob([thumbnailImage], { type: thumbnailFileType });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        metaDataBlob = new Blob([metadataJSON]);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
